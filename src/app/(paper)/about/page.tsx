...
There is no payment collection, no face recognition, and no public listing of phone numbers or email addresses. WhatsApp batch links are visible only after verification. The people directory is opt-in, field by field.
`;
