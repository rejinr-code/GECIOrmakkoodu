          ...
          <ul className="mt-10 space-y-10">
            {pending.map((photo) => (
              <li key={photo.id} className="border-t border-ink/8 pt-6">
                <SelectBox id={photo.id} label="Select" />
                {photo.thumbUrl ? (
                  ...
                  <img
                    ...
                    width={photo.width}
                    height={photo.height}
                    className="print-mat mt-3 max-h-72 w-full max-w-md object-contain"
                  />
                ) : (
                  <div className="print-mat mt-3 flex min-h-40 max-w-md items-end p-4 text-caption text-muted">
                    {photo.altText}
                  </div>
                )}
